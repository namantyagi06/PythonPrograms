...
delay = 0.1  # Time delay between movements
score = 0
high_score = 0

# Set up the screen
wn = turtle.Screen()
wn.title("Snake Game by Naman")
wn.bgcolor("black")
wn.setup(width=600, height=600)
wn.tracer(0)  # Turns off screen updates for smooth animation
...
segments = []  # List for snake body segments
